            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">GRAFICAS DE LA REGION CARIBE</h1>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">DEPARTAMENTOS DEL CARIBE COLOMBIANO</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <h4 class="small font-weight-bold">ATLANTICO <span
                                                class="float-right">293</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 96%"
                                                aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">BOLIVAR <span
                                                class="float-right">101</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                                aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">SUCRE <span
                                            class="float-right">61</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 70%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">MAGDALENA <span
                                                class="float-right">60</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 66%"
                                                aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">CORDOBA <span
                                                class="float-right">58</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 58%"
                                                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">CESAR <span
                                            class="float-right">53</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 53%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">LA GUAJIRA <span
                          ...
                          <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Accordion -->
                                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                        <h6 class="m-0 font-weight-bold text-primary">CIUDADES DEL CARIBE COLOMBIANO</h6>
                                    </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
...
<script>
    // setup 
    const datacircle = {
      labels: ['MODA','COMESTIBLES(ALIMENTOS Y BEBIDAS)','INDUSTRIAS CREATIVAS','TECNOLOGIA','BELLEZA','HOGAR','SALUD-FARMACIA','DEPORTES','ELECTRODOMESTICOS','EDUCACION','','','',''],
      datasets: [{
        label: 'Datos, Sector ventas',
        data: [143, 107, 76, 55, 51, 38, 14, 9, 6, 1],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
...
<script>
    // setup 
    const databar = {
      labels: ['BARRANQUILLA','CARTAGENA','SOLEDAD','SANTA MARTA','SINCELEJO','VALLEDUPAR','MONTERIA','RIOHACHA','TURBACO','PUERTO COLOMBIA','BARANOA','CERETE','MAICAO','FONSECA','CIENAGA','SAMPUES'],
      datasets: [{
        label: 'Datos, Ciudades',
        data: [190, 74, 55, 48, 43, 39, 34, 18, 10, 10, 8, 7, 6, 4, 4, 4],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
