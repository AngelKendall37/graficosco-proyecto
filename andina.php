            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">GRAFICAS DE LA REGION ANDINA</h1>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">DEPARTAMENTOS DE LA ZONA ANDINA COLOMBIANA</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <h4 class="small font-weight-bold">CUNDINAMARCA <span
                                                class="float-right">987</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 99%"
                                                aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">ANTIOQUIA <span
                                                class="float-right">448</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 86%"
                                                aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">SANTANDER <span
                                            class="float-right">168</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 76%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">RISARALDA <span
                                                class="float-right">107</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 70%"
                                                aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">BOYACA <span
                                                class="float-right">92</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 64%"
                                                aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">TOLIMA <span
                                            class="float-right">76</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 58%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">HUILA <span
                                        class="float-right">45</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 49%"
                                        aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">CALDAS <span
                                        class="float-right">44</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 47%"
                                        aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">QUINDIO <span
                                        class="float-right">39</span></h4>
                                        <div class="progress mb-4">
                          ...
                          <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Accordion -->
                                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                        <h6 class="m-0 font-weight-bold text-primary">CIUDADES DE LA ZONA ANDINA COLOMBIANO</h6>
                                    </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <div class="chart-area">
                                            <canvas id="areaChart" style="min-height: 300px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="chartCard">
  ...
  // setup 
  const data = {
    labels: ['BOGOTA','MEDELLIN','BUCARAMANGA','SABANETA','PEREIRA', 'ENVIGADO','IBAGUE','SOACHA','FUSAGASUGA','MANIZALES','SOGAMOSO','COTA','ARMENIA','DOSQUEBRADAS','NEIVA','BARRANCABERMEJA','MADRID','BELLO','ITAGUI'],
    datasets: [{
      label: 'Datos, Departamentos',
      data: [719, 186, 90, 70, 69, 61, 60, 38, 35, 32, 29, 28, 28, 26, 25, 22, 20, 20, 20],
      backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
...
<script>
    // setup 
    const datacircle = {
      labels: ['MODA','INDUSTRIAS CREATIVAS','COMESTIBLES','TECNOLOGIA','HOGAR','BELLEZA','SALUD-FARMACIA','DEPORTES','PRODUCTOS VETERINARIOS','ELECTRODOMESTICOS', 'EDUCACION','CONSTRUCCION'],
      datasets: [{
        label: 'Datos, Sector ventas',
        data: [376, 299, 293, 160, 125, 103, 69, 35, 27, 20, 8, 6],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
...
<script>
    // setup 
    const databar = {
      labels: ['TUNJA','CAJICA','CHIA','FUNZA','DUITAMA','FLORIDABLANCA','FACATATIVA','RIONEGRO','PIEDECUESTA','MOSQUERA','SOPO','SANTA ROSA DEL CABAL','GIRON','LA ESTRELLA','TOCANCIPA','APARTADO','CALDAS','TURBO','CHIQUINQUIRA'],
      datasets: [{
        label: 'Datos, Ciudades',
        data: [20, 16, 15, 15, 12, 12, 11, 11, 10, 9, 8, 8, 8, 7, 6, 6, 6, 6, 6],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
...
<script>
    // setup 
    const dataem = {
      labels: ['EMPRENDEDOR','EMPRESARIO','COMERCIANTE'],
      datasets: [{
...
<script>
    // setup 
    const dataam = {
      labels: ['SUPERIOR PREGRADO','SUPERIO POSGRADO','MEDIA','BASICA',],
      datasets: [{
        label: 'Datos, Participantes',
        data: [1055, 440, 335, 125],
        backgroundColor: [
          'rgba(75, 192, 192, 1)',
          'rgba(153, 102, 255, 1)',
          'rgba(54, 162, 235, 1)',
