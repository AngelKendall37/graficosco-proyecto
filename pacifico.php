            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">GRAFICAS DEL PACIFICO</h1>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">DEPARTAMENTOS DEL PACIFICO COLOMBIANO</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <h4 class="small font-weight-bold">VALLE DEL CAUCA <span
                                                class="float-right">463</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 98%"
                                                aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">CAUCA<span
                                                class="float-right">90</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 70%"
                                                aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">NARIÑO <span
                                            class="float-right">63</span></h4>
                                        <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 54%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">CHOCO <span
                          ...
                          <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Accordion -->
                                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                        <h6 class="m-0 font-weight-bold text-primary">CIUDADES DEL PACIFICO COLOMBIANO</h6>
                                    </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
...
<script>
    // setup 
    const datacircle = {
      labels: ['MODA','COMESTIBLES(ALIMENTOS Y BEBIDAS)','INDUSTRIAS CREATIVAS','TECNOLOGIA','HOGAR','BELLEZA','SALUD-FARMACIA','DEPORTES','ELECTRODOMESTICOS','EDUCACION','','','',''],
      datasets: [{
        label: 'Datos, Sector ventas',
        data: [99, 84, 76, 40, 39, 36, 21, 7, 5, 4],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
