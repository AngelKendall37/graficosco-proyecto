...
<script>
    // setup 
    const databar = {
      labels: ['BOGOTA','CALI','BARRANQUILLA','MEDELLIN','BUCARAMANGA','CUCUTA','PALMIRA','CARTAGENA','SABANETA','PEREIRA','POPAYAN','ENVIGADO','IBAGUE','SOLEDAD','SANTA MARTA','PASTO','SINCELEJO','VALLEDUPAR','SOACHA','FUSAGASUGA','VILLAVICENCIO','MONTERIA','MANIZALES','SOGAMOSO','ARMENIA','COTA','CARTAGO','DOSQUEBRADAS','NEIVA','LORICA'],
      datasets: [{
        label: 'Datos, Ciudades',
        data: [719, 247, 190, 186, 90, 85, 76, 74, 70, 69, 67, 61, 60, 48, 47, 43, 39, 38, 35, 34, 34, 32, 29, 29, 28, 28, 26, 25, 2],
        backgroundColor: [
      'rgba(54, 162, 235, 1)',
      'rgba(75, 192, 192, 1)',
      'rgba(54, 162, 235, 1)',
